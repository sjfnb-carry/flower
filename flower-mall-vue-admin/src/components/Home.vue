...
<style lang="less" scoped>
    .el-header {
      background-image: linear-gradient(to right top, #65b5db, #68b3df, #6db1e2, #73afe4, #7bace6, #8aa1e3, #9d95dc, #af87cf, #c86ca9, #d15578, #c54b42, #a65000);
