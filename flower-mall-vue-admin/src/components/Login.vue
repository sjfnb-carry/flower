<template>
  <div class="login_conn">
    <img style="width: 100%; hight: 100%" src="../assets/images/bglogin.jpg">
    <div class="login_box">
      <div style="width: 60%;height: 100%">
        <img src="../assets/images/65544.png" width="100%" height="100%" >
      </div>
      <div style=" background-color: #ffffff;width: 40%;height: 100%;text-align: center">
        <h1 style="margin-top: 50px;color: #a65000">鲜花商城管理系统</h1>
        <el-form class="form_login" :rules="loginRules" :model="user" ref="loginForm">
          ...
          <el-form-item class="btns">
            <el-button type="warning" @click="login" style="width: 100%;">登录</el-button>
