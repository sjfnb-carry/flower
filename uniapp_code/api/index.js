...
export const sendemail2 = (tableName, email,username) => {
	return http.request({
		url: `${tableName}/password?email=${email}&username=${username}&type=2`,
		method: 'GET'
	});
}
/**
...
export const chatAI = (ask) => {
	return http.request({
		url: `baidu/askai?ask=${ask}`,
		method: 'get'
