		...
		methods: {
			async init() {
				...
				for (let i = 0; i < this.cart.length; i++) {
					// 总金额
					if(this.user.vip=='是'){
						this.totalamount = parseFloat(this.totalamount) + parseFloat(this.cart[i].vipprice * this.cart[i].buynumber)
					}else{
					...
					if (this.cart) {
						for (var i = 0; i < this.cart.length; i++) {
							...
							if (this.isselected(this.cart[i].id)) {
								...
								// 更新总金额
								if(this.user.vip=='是'){
									this.totalamount = this.totalamount - this.cart[i].vipprice * this.cart[i].buynumber
								}else{
				...
				for (let i = 0; i < this.cart.length; i++) {
					if ((this.cart[i].id == itemid) && (this.cart[i].buynumber > 0)) {
						...
						if (this.isselected(this.cart[i].id)) {
							...
							// 更新总金额
							if(this.user.vip=='是'){
								this.updatetotalamt(-this.cart[i].vipprice)
							}else {
