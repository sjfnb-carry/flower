...
<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
	<view class="content">
		<view :style='{"width":"100%","padding":"0 0 0 0","position":"relative","background":"#EFEFEF","height":"100%"}'>
			<view :style='{"minHeight":"50px","alignItems":"center","background":"#EFEFEF","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
				<view :style='{"border":"1px solid #E9607F","backgroundColor":"#fff","margin":"0 10px","color":"#333333","alignItems":"center","borderRadius":"5px","flex":"1","display":"flex","lineHeight":"40px","fontSize":"12px","height":"40px"}'>
					...
					<input v-model="searchForm.shangjiamingcheng" type="text" placeholder="商家名称" :style='{"width":"100%","borderRadius":"5px","background":"#fff","height":"100%"}'></input>
				</view>
		...
		<button :style='{"border":"0","boxShadow":"0 1px 6px #00000030","color":"#fff","bottom":"20px","right":"4px","outline":"none","borderRadius":"100%","background":"#F8678C","width":"40px","lineHeight":"40px","fontSize":"14px","position":"absolute","height":"40px","zIndex":"999"}' v-if="userid && isAuth('shangjia','新增')" class="add-btn" @click="onAddTap()">新增</button>
		<button :style='{"border":"0","boxShadow":"0 1px 6px #00000030","color":"#fff","bottom":"20px","right":"4px","outline":"none","borderRadius":"100%","background":"#F8678C","width":"40px","lineHeight":"40px","fontSize":"14px","position":"absolute","height":"40px","zIndex":"999"}' v-if="!userid && isAuthFront('shangjia','新增')" class="add-btn" @click="onAddTap()">新增</button>
	</view>
