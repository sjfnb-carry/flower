...
<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
	<view class="content">
		<view :style='{"width":"100%","padding":"0 0 0 0","position":"relative","background":"#EFEFEF","height":"100%"}'>
			<view :style='{"minHeight":"50px","alignItems":"center","background":"#EFEFEF","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
				<view :style='{"border":"1px solid #E9607F","backgroundColor":"#fff","margin":"0 10px","color":"#333333","alignItems":"center","borderRadius":"5px","flex":"1","display":"flex","lineHeight":"40px","fontSize":"12px","height":"40px"}'>
					...
					<input v-model="searchForm.biaoti" type="text" placeholder="标题" :style='{"width":"100%","borderRadius":"5px","background":"#fff","height":"100%"}'></input>
				</view>
			...
			<view class="list" :style='{"width":"100%","padding":"12px 12px 12px 12px","margin":"0 0 0 0","height":"auto"}'>
				<view @tap="onDetailTap(product)" class="listm flex flex-between" :style='{"boxShadow":"0 1px 6px #00000030","padding":"10px","margin":"0 0 10px 0","borderRadius":"10px","flexWrap":"wrap","background":"#FFFFFF","display":"flex","width":"100%","height":"auto"}' v-for="(product,index) in list" :key="index">
				  ...
				  <view class="listmr" :style='{"padding":"0 0 0 0","margin":"0 10px","flexDirection":"column","display":"flex","width":"calc(100% - 120px)","justifyContent":"center","height":"auto"}'>
					<view class="col3 f30 elip mb15" :style='{"padding":"0 10px 0 10px","margin":"0 0 20px 0","color":"#000000","width":"100%","lineHeight":"24px","fontSize":"16px","fontWeight":"700"}'>标题:{{product.biaoti}}</view>
					<view class="col3 f30 elip mb15" :style='{"padding":"0 10px 0 10px","margin":"0 0 20px 0","color":"#000000","width":"100%","lineHeight":"24px","fontSize":"16px","fontWeight":"700"}'>发布日期:{{product.faburiqi}}</view>
				  </view>
					...
					<view :style='{"width":"calc(100% - 100px)","padding":"4px 10px 4px 10px","margin":"0 0 0 30%","justifyContent":"space-between","display":"flex","height":"auto"}'>
						<view :style='{"display":"flex"}' v-if="(userid && isAuth('xitonggonggao','修改')) || (!userid && isAuthFront('xitonggonggao','修改'))" @click.stop="onUpdateTap(product.id)">
						...
						<view :style='{"display":"flex"}' v-if="(userid && isAuth('xitonggonggao','删除')) || (!userid && isAuthFront('xitonggonggao','删除'))" @click.stop="onDeleteTap(product.id)">
		...
		<button :style='{"border":"0","boxShadow":"0 1px 6px #00000030","color":"#fff","bottom":"20px","right":"4px","outline":"none","borderRadius":"100%","background":"#F8678C","width":"40px","lineHeight":"40px","fontSize":"14px","position":"absolute","height":"40px","zIndex":"999"}' v-if="userid && isAuth('xitonggonggao','新增')" class="add-btn" @click="onAddTap()">新增</button>
		<button :style='{"border":"0","boxShadow":"0 1px 6px #00000030","color":"#fff","bottom":"20px","right":"4px","outline":"none","borderRadius":"100%","background":"#F8678C","width":"40px","lineHeight":"40px","fontSize":"14px","position":"absolute","height":"40px","zIndex":"999"}' v-if="!userid && isAuthFront('xitonggonggao','新增')" class="add-btn" @click="onAddTap()">新增</button>
	</view>
