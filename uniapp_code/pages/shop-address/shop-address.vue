<template>
	<view class="content b-t">
		<view class="list b-b" v-for="(item, index) in list" :key="index" @click="onSelectTap(item)">
			...
			<text class="iconfont icon-xiugai1" @click.stop="onAddressDtailTap(item.id)"></text>
			<text style="margin-left: 50upx;" class="iconfont icon-shanchu1" @click.stop="onDeleteTap(item.id)"></text>
		</view>
