...
<view class="lable" :style='{"width":"80px","padding":"0 10px 0 0","lineHeight":"40px","fontSize":"14px","color":"#333","textAlign":"right"}'>用户姓名：</view>
<view  class="text" :style='{"padding":"0 0 0 0","margin":"0 0 0 0","lineHeight":"40px","fontSize":"14px","color":"#000"}'>{{detail.yonghuxingming}}</view>
</view>
<view class="detail-list-item" :style='{"margin":"0 0 12px 0","borderColor":"#F8678C","borderWidth":"0 0 1px 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
<view class="lable" :style='{"width":"80px","padding":"0 10px 0 0","lineHeight":"40px","fontSize":"14px","color":"#333","textAlign":"right"}'>年龄：</view>
<view  class="text" :style='{"padding":"0 0 0 0","margin":"0 0 0 0","lineHeight":"40px","fontSize":"14px","color":"#000"}'>{{detail.nianling}}</view>
</view>
<view class="detail-list-item" :style='{"margin":"0 0 12px 0","borderColor":"#F8678C","borderWidth":"0 0 1px 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
<view class="lable" :style='{"width":"80px","padding":"0 10px 0 0","lineHeight":"40px","fontSize":"14px","color":"#333","textAlign":"right"}'>联系方式：</view>
<view  class="text" :style='{"padding":"0 0 0 0","margin":"0 0 0 0","lineHeight":"40px","fontSize":"14px","color":"#000"}'>{{detail.lianxifangshi}}</view>
</view>
<view class="detail-list-item" :style='{"margin":"0 0 12px 0","borderColor":"#F8678C","borderWidth":"0 0 1px 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
<view class="lable" :style='{"width":"80px","padding":"0 10px 0 0","lineHeight":"40px","fontSize":"14px","color":"#333","textAlign":"right"}'>账号：</view>
<view  class="text" :style='{"padding":"0 0 0 0","margin":"0 0 0 0","lineHeight":"40px","fontSize":"14px","color":"#000"}'>{{detail.zhanghao}}</view>
</view>
