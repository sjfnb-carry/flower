...
public interface ShangpinfenleiService extends IService<ShangpinfenleiEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<ShangpinfenleiEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<ShangpinfenleiEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<ShangpinfenleiEntity> wrapper);
